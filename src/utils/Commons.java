...
public interface Commons {
    ...
    public static final int PACMAN_HIDDEN_LAYER = 20;//(int) ((PACMAN_STATE_SIZE+PACMAN_NUM_ACTIONS)/2);s
    ...
    //PACMAN PARAMETERES
    public static final double MUTATION_CHANCE_PACMAN = 0.3;
    ...
    public static final int seed_PACMAN = 41 ;
